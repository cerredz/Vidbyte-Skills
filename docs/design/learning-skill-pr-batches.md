...
- Each retained skill has identity, intuition, goal, internal monologue, JSON artifact behavior, and a success checklist.
...
- `question-builder` uses the new skill name and command.

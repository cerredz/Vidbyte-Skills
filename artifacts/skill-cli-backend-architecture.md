...
The CLI is intentionally thin. Its job is to transform an already-written artifact into a signed backend request.
...
4. Add the endpoint path to `cli/client.js`.

export function usage(platformIds) {
  return `Usage: vidbyte-skills [skill-name|collection ...] [options]

Collections:
  default                           Non-reasoning skills only. Used when no selector is passed.
  reasoning                         Reasoning trace skills only.
  reasoning-traces                  Alias for reasoning.
  all                               Default and reasoning trace skills.

Options:
  --scope <user|project|both>       Install scope. Default: user
  --platform <list|all>             Comma-separated platforms. Default: all
  --skill <list>                    Comma-separated skill names or collections. Default: default

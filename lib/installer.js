...
export function installVidbyteSkills(argv) {
  ...
  const discoveredSkills = discoverSkills(environment.skillsRoot);
  ...
  const skills = selectRequestedSkills(discoveredSkills, options.skillNames);

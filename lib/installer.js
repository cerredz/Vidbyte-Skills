...
import { discoverSkills, filterByVersion, selectRequestedSkills } from "./skill-catalog.js";
...
export function installVidbyteSkills(argv) {
  ...
  const skills = readInstallableSkills(environment.skillsRoot, options.skillNames, options.version);

...
Fuzzy Logic Reasoning is a graded truth analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to use degrees of membership when categories are not cleanly true or false, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, fuzzy logic reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Fuzzy Logic Reasoning, not like a separate response pasted after the trace.

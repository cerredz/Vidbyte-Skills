---
name: stock-and-flow-trace-small
description: >
  Use this skill when the user invokes /stock-and-flow-trace-small or asks for a small public reasoning trace using Stock And Flow Reasoning.
...
# Stock And Flow Reasoning Reasoning Trace Small

...
Porters Five Forces is a competitive strategy strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to evaluate rivalry, entrants, substitutes, suppliers, and buyers before judging attractiveness, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, porters five forces changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Porters Five Forces, not like a separate response pasted after the trace.

---
name: causal-loop-trace-small
description: >
  Use this skill when the user invokes /causal-loop-trace-small or asks for a small public reasoning trace using Causal Loop Reasoning.
...
# Causal Loop Reasoning Reasoning Trace Small

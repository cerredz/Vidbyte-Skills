---
name: what-if-analysis-trace-large
description: >
  Use this skill when the user invokes /what-if-analysis-trace-large or asks for a large public reasoning trace using What If Analysis.
...
# What If Analysis Reasoning Trace Large

...
Evidence Triangulation is a evidence synthesis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to combine independent evidence streams and compare whether they converge, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, evidence triangulation changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Evidence Triangulation, not like a separate response pasted after the trace.

...
Nonmonotonic Reasoning is a revisable logic strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to allow new information to reduce or invalidate earlier conclusions, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, nonmonotonic reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Nonmonotonic Reasoning, not like a separate response pasted after the trace.

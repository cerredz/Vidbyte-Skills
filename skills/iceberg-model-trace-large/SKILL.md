---
name: iceberg-model-trace-large
description: >
  Use this skill when the user invokes /iceberg-model-trace-large or asks for a large public reasoning trace using Iceberg Model.
...
# Iceberg Model Reasoning Trace Large

---
name: predicate-logic-trace
description: >
  Use this skill when the user invokes /predicate-logic-trace or asks for a default public reasoning trace using Predicate Logic Reasoning.
...
# Predicate Logic Reasoning Reasoning Trace

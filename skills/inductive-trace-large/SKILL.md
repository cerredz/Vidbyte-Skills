---
name: inductive-trace-large
description: >
  Use this skill when the user invokes /inductive-trace-large or asks for a large public reasoning trace using Inductive Reasoning.
...
# Inductive Reasoning Reasoning Trace Large

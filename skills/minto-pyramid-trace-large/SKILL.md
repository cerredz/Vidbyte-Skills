---
name: minto-pyramid-trace-large
description: >
  Use this skill when the user invokes /minto-pyramid-trace-large or asks for a large public reasoning trace using Minto Pyramid.
...
# Minto Pyramid Reasoning Trace Large

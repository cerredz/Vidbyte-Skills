---
name: jobs-to-be-done-trace
description: >
  Use this skill when the user invokes /jobs-to-be-done-trace or asks for a default public reasoning trace using Jobs to be Done.
...
# Jobs to be Done Reasoning Trace

---
name: double-loop-learning-trace-large
description: >
  Use this skill when the user invokes /double-loop-learning-trace-large or asks for a large public reasoning trace using Double-Loop Learning.
...
# Double-Loop Learning Reasoning Trace Large

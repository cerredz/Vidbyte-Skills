---
name: base-rate-trace-small
description: >
  Use this skill when the user invokes /base-rate-trace-small or asks for a small public reasoning trace using Base Rate Reasoning.
...
# Base Rate Reasoning Reasoning Trace Small

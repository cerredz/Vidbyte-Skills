...
description: "Use this skill when the user invokes /narrative-reasoning-trace or asks for a default public reasoning trace using Narrative Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Narrative Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Narrative Reasoning strategy.
...
Apply Narrative Reasoning by using it to trace actors, motives, conflicts, turning points, and implied causal arcs, and make each numbered line advance that method rather than adding generic filler.
...
Narrative Reasoning is a story and causality analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to trace actors, motives, conflicts, turning points, and implied causal arcs, which helps the model expose reasoning checkpoints that a reader can inspect.

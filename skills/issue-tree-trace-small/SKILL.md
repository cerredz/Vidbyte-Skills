---
name: issue-tree-trace-small
description: >
  Use this skill when the user invokes /issue-tree-trace-small or asks for a small public reasoning trace using Issue Tree.
...
# Issue Tree Reasoning Trace Small

---
name: first-principles-trace-large
description: >
  Use this skill when the user invokes /first-principles-trace-large or asks for a large public reasoning trace using First Principles.
...
# First Principles Reasoning Trace Large

---
name: fermi-estimation-trace
description: >
  Use this skill when the user invokes /fermi-estimation-trace or asks for a default public reasoning trace using Fermi Estimation.
...
# Fermi Estimation Reasoning Trace

...
description: "Use this skill when the user invokes /scientific-method-trace-large or asks for a large public reasoning trace using Scientific Method. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 500 or more numbered scratchpad lines."
---

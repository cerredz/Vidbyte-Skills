---
name: feedback-loop-trace-small
description: >
  Use this skill when the user invokes /feedback-loop-trace-small or asks for a small public reasoning trace using Feedback Loop Reasoning.
...
# Feedback Loop Reasoning Reasoning Trace Small

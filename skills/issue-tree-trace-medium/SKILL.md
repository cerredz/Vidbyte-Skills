...
Issue Tree is a structured decomposition strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to branch the central question into subissues, resolve leaf nodes, and roll findings back to the trunk, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, issue tree changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Issue Tree, not like a separate response pasted after the trace.

---
name: bcg-matrix-trace-small
description: >
  Use this skill when the user invokes /bcg-matrix-trace-small or asks for a small public reasoning trace using BCG Growth-Share Matrix.
...
# BCG Growth-Share Matrix Reasoning Trace Small

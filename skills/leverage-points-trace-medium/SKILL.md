...
Leverage Points is a systems intervention strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to find places where small changes can shift system behavior materially, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, leverage points changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Leverage Points, not like a separate response pasted after the trace.

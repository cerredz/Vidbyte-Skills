...
Reframing Reasoning is a perspective shift strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to change the frame, owner, time horizon, or success definition before solving, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, reframing reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Reframing Reasoning, not like a separate response pasted after the trace.

...
Bowtie Risk Reasoning is a risk analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to connect threats, preventive controls, the central event, recovery controls, and consequences, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, bowtie risk reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Bowtie Risk Reasoning, not like a separate response pasted after the trace.

---
name: game-theory-trace
description: >
  Use this skill when the user invokes /game-theory-trace or asks for a default public reasoning trace using Game Theory.

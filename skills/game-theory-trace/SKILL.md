...
description: "Use this skill when the user invokes /game-theory-trace or asks for a default public reasoning trace using Game Theory. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Game Theory Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Game Theory strategy.
...
Apply Game Theory by using it to model players, payoffs, moves, information, and equilibria before choosing a strategy, and make each numbered line advance that method rather than adding generic filler.
...
Game Theory is a strategic interaction strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to model players, payoffs, moves, information, and equilibria before choosing a strategy, which helps the model expose reasoning checkpoints that a reader can inspect.

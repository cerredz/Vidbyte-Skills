---
name: fmea-trace-large
description: >
  Use this skill when the user invokes /fmea-trace-large or asks for a large public reasoning trace using Failure Mode and Effects Analysis.
...
# Failure Mode and Effects Analysis Reasoning Trace Large

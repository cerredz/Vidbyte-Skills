---
name: horizon-scanning-trace-small
description: "Use this skill when the user invokes /horizon-scanning-trace-small or asks for a small public reasoning trace using Horizon Scanning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

# Horizon Scanning Reasoning Trace Small

---
name: causal-loop-trace
description: >
  Use this skill when the user invokes /causal-loop-trace or asks for a default public reasoning trace using Causal Loop Reasoning.
...
# Causal Loop Reasoning Reasoning Trace

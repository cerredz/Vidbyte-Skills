...
description: "Use this skill when the user invokes /uncertainty-quantification-trace-small or asks for a small public reasoning trace using Uncertainty Quantification. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

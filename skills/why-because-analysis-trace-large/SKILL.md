---
name: why-because-analysis-trace-large
description: >
  Use this skill when the user invokes /why-because-analysis-trace-large or asks for a large public reasoning trace using Why-Because Analysis.
...
# Why-Because Analysis Reasoning Trace Large

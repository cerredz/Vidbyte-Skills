---
name: fermi-estimation-trace-large
description: >
  Use this skill when the user invokes /fermi-estimation-trace-large or asks for a large public reasoning trace using Fermi Estimation.
...
# Fermi Estimation Reasoning Trace Large

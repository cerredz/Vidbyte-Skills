---
name: double-loop-learning-trace-small
description: >
  Use this skill when the user invokes /double-loop-learning-trace-small or asks for a small public reasoning trace using Double-Loop Learning.
...
# Double-Loop Learning Reasoning Trace Small

---
name: ooda-loop-trace-small
description: >
  Use this skill when the user invokes /ooda-loop-trace-small or asks for a small public reasoning trace using OODA Loop.
...
# OODA Loop Reasoning Trace Small

---
name: spider-mapping-trace-large
description: >
  Use this skill when the user invokes /spider-mapping-trace-large or asks for a large public reasoning trace using Spider Mapping.
...
# Spider Mapping Reasoning Trace Large

---
name: jobs-to-be-done-trace-medium
description: >
  Use this skill when the user invokes /jobs-to-be-done-trace-medium or asks for a medium public reasoning trace using Jobs to be Done.
  The skill writes a durable scratchpad to root memory/{question_name}.md and uses Jobs to be Done as the actual structure of the analysis.
  ...
  Use this skill when the user wants the answer shaped by understanding the functional, social, and emotional dimensions of what customers hire a product to do instead of a generic response.
---

# Jobs to be Done Reasoning Trace Medium

## Goal
Use Jobs to be Done to answer the user's question through understanding the functional, social, and emotional dimensions of what customers hire a product to do, not through a generic checklist or interchangeable trace.
The trace should identify the functional, social, and emotional jobs customers are hiring a product or service to accomplish, and the circumstances that trigger the hire, so the visible reasoning follows the same path the strategy is known for.
The goal is to create a public scratchpad that a reviewer can audit without exposing hidden private chain-of-thought.
Center the scratchpad on subquestions, assumptions, evidence, contrasts, tests, intermediate conclusions, and implications, because those artifacts make jobs to be done useful rather than decorative.
...
Build the scratchpad by repeatedly applying the Jobs to be Done move: identify the functional, social, and emotional jobs customers are hiring a product or service to accomplish, and the circumstances that trigger the hire.
...
Jobs to be Done is a reasoning strategy for turning a question into an auditable public trace instead of an unstructured opinion.
...
Use it when the problem benefits from the core move "identify the functional, social, and emotional jobs customers are hiring a product or service to accomplish, and the circumstances that trigger the hire" and when the final answer needs evidence, assumptions, and uncertainty kept in view.
A strong Jobs to be Done trace lets that move determine the order and granularity of the scratchpad, then compresses the result into a concise final answer.

Algorithm for the output document:
1. Restate the user's question, constraints, and evidence standard, then derive the subquestions or working items that Jobs to be Done needs to inspect.
2. Apply the core move explicitly: identify the functional, social, and emotional jobs customers are hiring a product or service to accomplish, and the circumstances that trigger the hire.
...
5. Synthesize the completed trace into the final answer, showing how the conclusion follows from Jobs to be Done rather than from a generic summary.

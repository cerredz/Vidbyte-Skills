...
SCAMPER Reasoning is a creative modification strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to use substitute, combine, adapt, modify, put to another use, eliminate, and reverse prompts, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, scamper reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of SCAMPER Reasoning, not like a separate response pasted after the trace.

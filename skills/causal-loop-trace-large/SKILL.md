---
name: causal-loop-trace-large
description: >
  Use this skill when the user invokes /causal-loop-trace-large or asks for a large public reasoning trace using Causal Loop Reasoning.
...
# Causal Loop Reasoning Reasoning Trace Large

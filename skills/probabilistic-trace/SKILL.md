...
description: "Use this skill when the user invokes /probabilistic-trace or asks for a default public reasoning trace using Probabilistic Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

---
name: blue-ocean-strategy-trace-large
description: >
  Use this skill when the user invokes /blue-ocean-strategy-trace-large or asks for a large public reasoning trace using Blue Ocean Strategy.
...
# Blue Ocean Strategy Reasoning Trace Large

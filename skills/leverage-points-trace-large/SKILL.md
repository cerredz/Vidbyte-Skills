---
name: leverage-points-trace-large
description: >
  Use this skill when the user invokes /leverage-points-trace-large or asks for a large public reasoning trace using Leverage Points.
...
# Leverage Points Reasoning Trace Large

---
name: trial-and-error-trace-large
description: >
  Use this skill when the user invokes /trial-and-error-trace-large or asks for a large public reasoning trace using Trial and Error.
...
# Trial and Error Reasoning Trace Large

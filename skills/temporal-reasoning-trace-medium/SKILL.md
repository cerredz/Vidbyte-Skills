...
Temporal Reasoning is a time-based logic strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to order events, durations, deadlines, lags, and time-dependent constraints, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, temporal reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Temporal Reasoning, not like a separate response pasted after the trace.

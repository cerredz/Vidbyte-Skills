---
name: causal-trace-large
description: >
  Use this skill when the user invokes /causal-trace-large or asks for a large public reasoning trace using Causal Reasoning.
...
# Causal Reasoning Reasoning Trace Large

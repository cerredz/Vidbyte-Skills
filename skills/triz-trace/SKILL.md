---
name: triz-trace
description: "Use this skill when the user invokes /triz-trace or asks for a default public reasoning trace using TRIZ Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# TRIZ Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the TRIZ Reasoning strategy.
...
Apply TRIZ Reasoning by using it to name contradictions, search invention patterns, and resolve constraints without simple compromise, and make each numbered line advance that method rather than adding generic filler.
...
TRIZ Reasoning is a inventive problem solving strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to name contradictions, search invention patterns, and resolve constraints without simple compromise, which helps the model expose reasoning checkpoints that a reader can inspect.

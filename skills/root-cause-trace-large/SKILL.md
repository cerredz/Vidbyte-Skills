---
name: root-cause-trace-large
description: >
  Use this skill when the user invokes /root-cause-trace-large or asks for a large public reasoning trace using Root Cause Reasoning.
...
# Root Cause Reasoning Reasoning Trace Large

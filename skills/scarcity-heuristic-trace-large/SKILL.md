---
name: scarcity-heuristic-trace-large
description: >
  Use this skill when the user invokes /scarcity-heuristic-trace-large or asks for a large public reasoning trace using Scarcity Heuristic.
...
# Scarcity Heuristic Reasoning Trace Large

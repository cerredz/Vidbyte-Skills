---
name: bowtie-risk-trace-large
description: >
  Use this skill when the user invokes /bowtie-risk-trace-large or asks for a large public reasoning trace using Bowtie Risk Reasoning.
...
# Bowtie Risk Reasoning Reasoning Trace Large

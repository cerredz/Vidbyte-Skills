---
name: random-stimulus-trace-large
description: >
  Use this skill when the user invokes /random-stimulus-trace-large or asks for a large public reasoning trace using Random Stimulus.
...
# Random Stimulus Reasoning Trace Large

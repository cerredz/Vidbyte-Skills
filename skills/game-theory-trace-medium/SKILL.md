...
Game Theory is a strategic interaction strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to model players, payoffs, moves, information, and equilibria before choosing a strategy, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, game theory changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Game Theory, not like a separate response pasted after the trace.

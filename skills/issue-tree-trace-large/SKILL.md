---
name: issue-tree-trace-large
description: >
  Use this skill when the user invokes /issue-tree-trace-large or asks for a large public reasoning trace using Issue Tree.
...
# Issue Tree Reasoning Trace Large

---
name: lateral-thinking-trace-large
description: >
  Use this skill when the user invokes /lateral-thinking-trace-large or asks for a large public reasoning trace using Lateral Thinking.
...
# Lateral Thinking Reasoning Trace Large

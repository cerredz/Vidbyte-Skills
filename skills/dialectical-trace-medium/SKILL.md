---
name: dialectical-trace-medium
description: >
  Use this skill when the user invokes /dialectical-trace-medium or asks for a medium public reasoning trace using Dialectical Reasoning.
...
# Dialectical Reasoning Reasoning Trace Medium
...
Dialectical Reasoning is a reasoning strategy for turning a question into an auditable public trace instead of an unstructured opinion.
...
Use it when the problem benefits from the core move "develop thesis, antithesis, and synthesis while preserving the strongest opposing insight" and when the final answer needs evidence, assumptions, and uncertainty kept in view.
A strong Dialectical Reasoning trace lets that move determine the order and granularity of the scratchpad, then compresses the result into a concise final answer.

Algorithm for the output document:
1. Restate the user's question, constraints, and evidence standard, then derive the subquestions or working items that Dialectical Reasoning needs to inspect.
2. Apply the core move explicitly: develop thesis, antithesis, and synthesis while preserving the strongest opposing insight.
...
5. Synthesize the completed trace into the final answer, showing how the conclusion follows from Dialectical Reasoning rather than from a generic summary.

---
name: ooda-loop-trace-large
description: >
  Use this skill when the user invokes /ooda-loop-trace-large or asks for a large public reasoning trace using OODA Loop.
...
# OODA Loop Reasoning Trace Large

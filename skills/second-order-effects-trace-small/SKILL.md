---
name: second-order-effects-trace-small
description: >
  Use this skill when the user invokes /second-order-effects-trace-small or asks for a small public reasoning trace using Second Order Effects.
...
# Second Order Effects Reasoning Trace Small

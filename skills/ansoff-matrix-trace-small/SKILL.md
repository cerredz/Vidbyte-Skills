---
name: ansoff-matrix-trace-small
description: >
  Use this skill when the user invokes /ansoff-matrix-trace-small or asks for a small public reasoning trace using Ansoff Matrix.
...
# Ansoff Matrix Reasoning Trace Small

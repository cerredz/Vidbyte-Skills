---
name: reference-class-forecasting-trace-large
description: >
  Use this skill when the user invokes /reference-class-forecasting-trace-large or asks for a large public reasoning trace using Reference Class Forecasting.
...
# Reference Class Forecasting Reasoning Trace Large

---
name: outside-view-trace
description: >
  Use this skill when the user invokes /outside-view-trace or asks for a default public reasoning trace using Outside View.

---
name: steelman-trace-large
description: >
  Use this skill when the user invokes /steelman-trace-large or asks for a large public reasoning trace using Steelman Reasoning.
...
# Steelman Reasoning Reasoning Trace Large

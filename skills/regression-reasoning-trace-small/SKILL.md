...
description: "Use this skill when the user invokes /regression-reasoning-trace-small or asks for a small public reasoning trace using Regression Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

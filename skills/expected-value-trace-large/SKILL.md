---
name: expected-value-trace-large
description: >
  Use this skill when the user invokes /expected-value-trace-large or asks for a large public reasoning trace using Expected Value Reasoning.
...
# Expected Value Reasoning Reasoning Trace Large

---
name: fluency-heuristic-trace-large
description: >
  Use this skill when the user invokes /fluency-heuristic-trace-large or asks for a large public reasoning trace using Fluency Heuristic.
...
# Fluency Heuristic Reasoning Trace Large

...
Causal Loop Reasoning is a systems dynamics strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to represent reinforcing and balancing loops that drive the behavior of the system, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, causal loop reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Causal Loop Reasoning, not like a separate response pasted after the trace.

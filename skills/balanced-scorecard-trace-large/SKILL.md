---
name: balanced-scorecard-trace-large
description: >
  Use this skill when the user invokes /balanced-scorecard-trace-large or asks for a large public reasoning trace using Balanced Scorecard.
...
# Balanced Scorecard Reasoning Trace Large

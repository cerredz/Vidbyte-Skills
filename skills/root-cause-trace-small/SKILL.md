---
name: root-cause-trace-small
description: >
  Use this skill when the user invokes /root-cause-trace-small or asks for a small public reasoning trace using Root Cause Reasoning.
...
# Root Cause Reasoning Reasoning Trace Small

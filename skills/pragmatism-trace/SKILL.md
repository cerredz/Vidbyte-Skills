---
name: pragmatism-trace
description: >
  Use this skill when the user invokes /pragmatism-trace or asks for a default public reasoning trace using Pragmatism.

---
name: postmortem-trace-large
description: >
  Use this skill when the user invokes /postmortem-trace-large or asks for a large public reasoning trace using Postmortem Reasoning.
...
# Postmortem Reasoning Reasoning Trace Large

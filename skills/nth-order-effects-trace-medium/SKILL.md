...
Nth Order Effects is a consequence analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to extend consequence chains across multiple steps while pruning speculative branches, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, nth order effects changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Nth Order Effects, not like a separate response pasted after the trace.

---
name: decision-matrix-trace
description: >
  Use this skill when the user invokes /decision-matrix-trace or asks for a default public reasoning trace using Decision Matrix.
...
# Decision Matrix Reasoning Trace

---
name: event-tree-trace-large
description: >
  Use this skill when the user invokes /event-tree-trace-large or asks for a large public reasoning trace using Event Tree Analysis.
...
# Event Tree Analysis Reasoning Trace Large

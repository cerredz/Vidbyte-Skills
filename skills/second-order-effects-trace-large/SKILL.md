---
name: second-order-effects-trace-large
description: >
  Use this skill when the user invokes /second-order-effects-trace-large or asks for a large public reasoning trace using Second Order Effects.
...
# Second Order Effects Reasoning Trace Large

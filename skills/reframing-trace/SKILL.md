...
description: "Use this skill when the user invokes /reframing-trace or asks for a default public reasoning trace using Reframing Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Reframing Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Reframing Reasoning strategy.
...
Apply Reframing Reasoning by using it to change the frame, owner, time horizon, or success definition before solving, and make each numbered line advance that method rather than adding generic filler.
...
Reframing Reasoning is a perspective shift strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to change the frame, owner, time horizon, or success definition before solving, which helps the model expose reasoning checkpoints that a reader can inspect.

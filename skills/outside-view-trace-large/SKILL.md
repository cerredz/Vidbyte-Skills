---
name: outside-view-trace-large
description: >
  Use this skill when the user invokes /outside-view-trace-large or asks for a large public reasoning trace using Outside View.
...
# Outside View Reasoning Trace Large

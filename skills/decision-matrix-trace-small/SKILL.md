---
name: decision-matrix-trace-small
description: >
  Use this skill when the user invokes /decision-matrix-trace-small or asks for a small public reasoning trace using Decision Matrix.
...
# Decision Matrix Reasoning Trace Small

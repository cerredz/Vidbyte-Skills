---
name: experimental-design-trace-large
description: >
  Use this skill when the user invokes /experimental-design-trace-large or asks for a large public reasoning trace using Experimental Design.
...
# Experimental Design Reasoning Trace Large

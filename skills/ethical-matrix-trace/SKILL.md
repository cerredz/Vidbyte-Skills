...
description: "Use this skill when the user invokes /ethical-matrix-trace or asks for a default public reasoning trace using Ethical Matrix. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Ethical Matrix Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Ethical Matrix strategy.
...
Apply Ethical Matrix by using it to compare affected groups against principles such as wellbeing, autonomy, fairness, and responsibility, and make each numbered line advance that method rather than adding generic filler.
...
Ethical Matrix is a ethical analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to compare affected groups against principles such as wellbeing, autonomy, fairness, and responsibility, which helps the model expose reasoning checkpoints that a reader can inspect.

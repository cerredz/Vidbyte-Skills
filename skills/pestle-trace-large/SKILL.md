---
name: pestle-trace-large
description: >
  Use this skill when the user invokes /pestle-trace-large or asks for a large public reasoning trace using PESTLE Reasoning.
...
# PESTLE Reasoning Reasoning Trace Large

...
Experimental Design is a empirical inquiry strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to define variables, controls, measures, randomization, and validity risks, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, experimental design changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Experimental Design, not like a separate response pasted after the trace.

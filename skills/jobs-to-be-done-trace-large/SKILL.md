---
name: jobs-to-be-done-trace-large
description: >
  Use this skill when the user invokes /jobs-to-be-done-trace-large or asks for a large public reasoning trace using Jobs to be Done.
...
# Jobs to be Done Reasoning Trace Large

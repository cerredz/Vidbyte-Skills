...
Policy Analysis is a public decision analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to compare policy options by goals, feasibility, effects, equity, and implementation risk, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, policy analysis changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Policy Analysis, not like a separate response pasted after the trace.

---
name: deception-detection-trace
description: >
  Use this skill when the user invokes /deception-detection-trace or asks for a default public reasoning trace using Deception Detection.
...
# Deception Detection Reasoning Trace

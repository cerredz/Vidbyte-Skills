...
Scenario Planning is a future uncertainty analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to construct distinct plausible futures and test decisions across them, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, scenario planning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Scenario Planning, not like a separate response pasted after the trace.

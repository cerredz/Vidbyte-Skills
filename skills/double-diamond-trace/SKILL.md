---
name: double-diamond-trace
description: >
  Use this skill when the user invokes /double-diamond-trace or asks for a default public reasoning trace using Double Diamond.
...
# Double Diamond Reasoning Trace

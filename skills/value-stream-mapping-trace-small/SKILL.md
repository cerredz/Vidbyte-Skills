---
name: value-stream-mapping-trace-small
description: >
  Use this skill when the user invokes /value-stream-mapping-trace-small or asks for a small public reasoning trace using Value Stream Mapping.
...
# Value Stream Mapping Reasoning Trace Small

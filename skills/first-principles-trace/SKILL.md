---
name: first-principles-trace
description: >
  Use this skill when the user invokes /first-principles-trace or asks for a default public reasoning trace using First Principles.
...
# First Principles Reasoning Trace

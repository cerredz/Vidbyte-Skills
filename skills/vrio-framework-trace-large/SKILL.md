---
name: vrio-framework-trace-large
description: >
  Use this skill when the user invokes /vrio-framework-trace-large or asks for a large public reasoning trace using VRIO Framework.
...
# VRIO Framework Reasoning Trace Large

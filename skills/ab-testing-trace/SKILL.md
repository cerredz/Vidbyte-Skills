---
name: ab-testing-trace
description: >
  Use this skill when the user invokes /ab-testing-trace or asks for a default public reasoning trace using A B Testing.

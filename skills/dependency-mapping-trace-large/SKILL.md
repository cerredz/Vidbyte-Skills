---
name: dependency-mapping-trace-large
description: >
  Use this skill when the user invokes /dependency-mapping-trace-large or asks for a large public reasoning trace using Dependency Mapping.
...
# Dependency Mapping Reasoning Trace Large

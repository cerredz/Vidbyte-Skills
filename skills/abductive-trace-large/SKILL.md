---
name: abductive-trace-large
description: >
  Use this skill when the user invokes /abductive-trace-large or asks for a large public reasoning trace using Abductive Reasoning.
...
# Abductive Reasoning Reasoning Trace Large

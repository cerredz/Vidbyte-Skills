---
name: affect-heuristic-trace-large
description: >
  Use this skill when the user invokes /affect-heuristic-trace-large or asks for a large public reasoning trace using Affect Heuristic.
...
# Affect Heuristic Reasoning Trace Large

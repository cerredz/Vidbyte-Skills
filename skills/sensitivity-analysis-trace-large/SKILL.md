---
name: sensitivity-analysis-trace-large
description: >
  Use this skill when the user invokes /sensitivity-analysis-trace-large or asks for a large public reasoning trace using Sensitivity Analysis.
...
# Sensitivity Analysis Reasoning Trace Large

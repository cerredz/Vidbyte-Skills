...
Lateral Thinking is a creative problem solving strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to approach the problem indirectly, break habitual frames, and generate non-obvious moves, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, lateral thinking changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Lateral Thinking, not like a separate response pasted after the trace.

---
name: double-diamond-trace-large
description: >
  Use this skill when the user invokes /double-diamond-trace-large or asks for a large public reasoning trace using Double Diamond.
...
# Double Diamond Reasoning Trace Large

---
name: tradeoff-matrix-trace-large
description: >
  Use this skill when the user invokes /tradeoff-matrix-trace-large or asks for a large public reasoning trace using Tradeoff Matrix.
...
# Tradeoff Matrix Reasoning Trace Large

...
name: dmaic-trace
description: >
  Use this skill when the user invokes /dmaic-trace or asks for a default public reasoning trace using DMAIC Methodology.
...
# DMAIC Methodology Reasoning Trace

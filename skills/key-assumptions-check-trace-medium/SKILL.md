...
Key Assumptions Check is a structured analytic technique strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to surface critical assumptions, test fragility, and revise conclusions where assumptions are weak, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, key assumptions check changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Key Assumptions Check, not like a separate response pasted after the trace.

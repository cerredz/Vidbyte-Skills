---
name: backward-chaining-trace-large
description: >
  Use this skill when the user invokes /backward-chaining-trace-large or asks for a large public reasoning trace using Backward Chaining.
...
# Backward Chaining Reasoning Trace Large

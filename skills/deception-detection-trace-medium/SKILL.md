...
Deception Detection is a adversarial evidence analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to ask how evidence could be manipulated, fabricated, omitted, or misread, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, deception detection changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Deception Detection, not like a separate response pasted after the trace.

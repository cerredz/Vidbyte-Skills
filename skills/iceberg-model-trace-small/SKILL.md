---
name: iceberg-model-trace-small
description: >
  Use this skill when the user invokes /iceberg-model-trace-small or asks for a small public reasoning trace using Iceberg Model.
...
# Iceberg Model Reasoning Trace Small

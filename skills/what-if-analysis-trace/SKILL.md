---
name: what-if-analysis-trace
description: >
  Use this skill when the user invokes /what-if-analysis-trace or asks for a default public reasoning trace using What If Analysis.
...
# What If Analysis Reasoning Trace

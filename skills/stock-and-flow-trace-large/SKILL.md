---
name: stock-and-flow-trace-large
description: >
  Use this skill when the user invokes /stock-and-flow-trace-large or asks for a large public reasoning trace using Stock And Flow Reasoning.
...
# Stock And Flow Reasoning Reasoning Trace Large

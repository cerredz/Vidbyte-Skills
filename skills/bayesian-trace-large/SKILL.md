---
name: bayesian-trace-large
description: >
  Use this skill when the user invokes /bayesian-trace-large or asks for a large public reasoning trace using Bayesian Reasoning.
...
# Bayesian Reasoning Reasoning Trace Large

---
name: forward-chaining-trace-large
description: >
  Use this skill when the user invokes /forward-chaining-trace-large or asks for a large public reasoning trace using Forward Chaining.
...
# Forward Chaining Reasoning Trace Large

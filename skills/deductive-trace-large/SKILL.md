---
name: deductive-trace-large
description: >
  Use this skill when the user invokes /deductive-trace-large or asks for a large public reasoning trace using Deductive Reasoning.
...
# Deductive Reasoning Reasoning Trace Large

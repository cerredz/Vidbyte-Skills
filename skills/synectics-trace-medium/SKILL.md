...
Synectics Reasoning is a creative analogy strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to use direct, personal, symbolic, and fantasy analogies to reframe the problem, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, synectics reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Synectics Reasoning, not like a separate response pasted after the trace.

---
name: influence-diagram-trace
description: >
  Use this skill when the user invokes /influence-diagram-trace or asks for a default public reasoning trace using Influence Diagram.
...
# Influence Diagram Reasoning Trace

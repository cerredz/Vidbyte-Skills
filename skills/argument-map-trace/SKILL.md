---
name: argument-map-trace
description: >
  Use this skill when the user invokes /argument-map-trace or asks for a default public reasoning trace using Argument Mapping.
...
# Argument Mapping Reasoning Trace

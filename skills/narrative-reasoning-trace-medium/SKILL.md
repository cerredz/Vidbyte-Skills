...
Narrative Reasoning is a story and causality analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to trace actors, motives, conflicts, turning points, and implied causal arcs, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, narrative reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Narrative Reasoning, not like a separate response pasted after the trace.

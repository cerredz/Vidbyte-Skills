...
Error Analysis is a diagnostic evaluation strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to categorize failures, estimate frequency, and identify the changes most likely to reduce them, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, error analysis changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Error Analysis, not like a separate response pasted after the trace.

---
name: key-assumptions-check-trace
description: >
  Use this skill when the user invokes /key-assumptions-check-trace or asks for a default public reasoning trace using Key Assumptions Check.
...
# Key Assumptions Check Reasoning Trace

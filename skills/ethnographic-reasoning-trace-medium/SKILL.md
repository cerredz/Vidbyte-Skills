...
Ethnographic Reasoning is a contextual social analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to infer meaning from practices, language, setting, and participant perspective, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, ethnographic reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Ethnographic Reasoning, not like a separate response pasted after the trace.

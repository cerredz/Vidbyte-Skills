---
name: bcg-matrix-trace-large
description: >
  Use this skill when the user invokes /bcg-matrix-trace-large or asks for a large public reasoning trace using BCG Growth-Share Matrix.
...
# BCG Growth-Share Matrix Reasoning Trace Large

---
name: expected-value-trace-small
description: >
  Use this skill when the user invokes /expected-value-trace-small or asks for a small public reasoning trace using Expected Value Reasoning.
...
# Expected Value Reasoning Reasoning Trace Small

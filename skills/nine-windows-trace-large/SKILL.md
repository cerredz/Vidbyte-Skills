---
name: nine-windows-trace-large
description: >
  Use this skill when the user invokes /nine-windows-trace-large or asks for a large public reasoning trace using Nine Windows.
...
# Nine Windows Reasoning Trace Large

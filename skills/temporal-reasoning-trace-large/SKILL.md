---
name: temporal-reasoning-trace-large
description: >
  Use this skill when the user invokes /temporal-reasoning-trace-large or asks for a large public reasoning trace using Temporal Reasoning.
...
# Temporal Reasoning Reasoning Trace Large

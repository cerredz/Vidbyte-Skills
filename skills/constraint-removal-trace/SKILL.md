---
name: constraint-removal-trace
description: >
  Use this skill when the user invokes /constraint-removal-trace or asks for a default public reasoning trace using Constraint Removal.
...
# Constraint Removal Reasoning Trace

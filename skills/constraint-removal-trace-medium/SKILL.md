...
Constraint Removal is a creative problem solving strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to temporarily remove assumed limits and inspect what new options appear, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, constraint removal changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Constraint Removal, not like a separate response pasted after the trace.

---
name: value-chain-analysis-trace-large
description: >
  Use this skill when the user invokes /value-chain-analysis-trace-large or asks for a large public reasoning trace using Value Chain Analysis.
...
# Value Chain Analysis Reasoning Trace Large

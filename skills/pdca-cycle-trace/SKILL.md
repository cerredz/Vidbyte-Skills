---
name: pdca-cycle-trace
description: >
  Use this skill when the user invokes /pdca-cycle-trace or asks for a default public reasoning trace using PDCA Cycle.

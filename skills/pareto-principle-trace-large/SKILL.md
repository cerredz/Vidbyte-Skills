---
name: pareto-principle-trace-large
description: >
  Use this skill when the user invokes /pareto-principle-trace-large or asks for a large public reasoning trace using Pareto Principle.
...
# Pareto Principle Reasoning Trace Large

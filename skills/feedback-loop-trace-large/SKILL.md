---
name: feedback-loop-trace-large
description: >
  Use this skill when the user invokes /feedback-loop-trace-large or asks for a large public reasoning trace using Feedback Loop Reasoning.
...
# Feedback Loop Reasoning Reasoning Trace Large

---
name: concept-mapping-trace-large
description: >
  Use this skill when the user invokes /concept-mapping-trace-large or asks for a large public reasoning trace using Concept Mapping.
...
# Concept Mapping Reasoning Trace Large

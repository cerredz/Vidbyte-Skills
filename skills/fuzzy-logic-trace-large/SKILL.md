---
name: fuzzy-logic-trace-large
description: >
  Use this skill when the user invokes /fuzzy-logic-trace-large or asks for a large public reasoning trace using Fuzzy Logic Reasoning.
...
# Fuzzy Logic Reasoning Reasoning Trace Large

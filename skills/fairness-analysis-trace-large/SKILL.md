---
name: fairness-analysis-trace-large
description: >
  Use this skill when the user invokes /fairness-analysis-trace-large or asks for a large public reasoning trace using Fairness Analysis.
...
# Fairness Analysis Reasoning Trace Large

---
name: spider-mapping-trace
description: >
  Use this skill when the user invokes /spider-mapping-trace or asks for a default public reasoning trace using Spider Mapping.
...
# Spider Mapping Reasoning Trace

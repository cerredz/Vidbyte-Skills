---
name: inversion-trace-medium
description: >
  Use this skill when the user invokes /inversion-trace-medium or asks for a medium public reasoning trace using Inversion.
...
# Inversion Reasoning Trace Medium

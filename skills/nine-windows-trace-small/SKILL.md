---
name: nine-windows-trace-small
description: >
  Use this skill when the user invokes /nine-windows-trace-small or asks for a small public reasoning trace using Nine Windows.
...
# Nine Windows Reasoning Trace Small

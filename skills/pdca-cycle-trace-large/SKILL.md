---
name: pdca-cycle-trace-large
description: >
  Use this skill when the user invokes /pdca-cycle-trace-large or asks for a large public reasoning trace using PDCA Cycle.
...
# PDCA Cycle Reasoning Trace Large

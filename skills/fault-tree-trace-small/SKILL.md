---
name: fault-tree-trace-small
description: >
  Use this skill when the user invokes /fault-tree-trace-small or asks for a small public reasoning trace using Fault Tree Analysis.
...
# Fault Tree Analysis Reasoning Trace Small

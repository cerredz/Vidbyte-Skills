...
description: "Use this skill when the user invokes /fault-tree-trace-small or asks for a small public reasoning trace using Fault Tree Analysis. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

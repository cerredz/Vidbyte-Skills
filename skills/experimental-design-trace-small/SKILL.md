---
name: experimental-design-trace-small
description: >
  Use this skill when the user invokes /experimental-design-trace-small or asks for a small public reasoning trace using Experimental Design.
...
# Experimental Design Reasoning Trace Small

...
Cost Benefit Reasoning is a decision analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to identify costs, benefits, timing, risk, and distribution before recommending action, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, cost benefit reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Cost Benefit Reasoning, not like a separate response pasted after the trace.

---
name: policy-analysis-trace-large
description: >
  Use this skill when the user invokes /policy-analysis-trace-large or asks for a large public reasoning trace using Policy Analysis.
...
# Policy Analysis Reasoning Trace Large

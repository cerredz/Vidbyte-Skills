...
PESTLE Reasoning is a macro-environment analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to scan political, economic, social, technological, legal, and environmental forces, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, pestle reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of PESTLE Reasoning, not like a separate response pasted after the trace.

...
Provocation Reasoning is a lateral thinking strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to make a deliberate unreasonable statement and mine it for practical insight, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, provocation reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Provocation Reasoning, not like a separate response pasted after the trace.

...
description: "Use this skill when the user invokes /assumption-ladder-trace-small or asks for a small public reasoning trace using Assumption Ladder. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

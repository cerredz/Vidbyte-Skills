---
name: hazop-trace-large
description: >
  Use this skill when the user invokes /hazop-trace-large or asks for a large public reasoning trace using HAZOP Analysis.
...
# HAZOP Analysis Reasoning Trace Large

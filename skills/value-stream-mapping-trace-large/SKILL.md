---
name: value-stream-mapping-trace-large
description: >
  Use this skill when the user invokes /value-stream-mapping-trace-large or asks for a large public reasoning trace using Value Stream Mapping.
...
# Value Stream Mapping Reasoning Trace Large

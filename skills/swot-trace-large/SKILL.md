---
name: swot-trace-large
description: >
  Use this skill when the user invokes /swot-trace-large or asks for a large public reasoning trace using SWOT Reasoning.
...
# SWOT Reasoning Reasoning Trace Large

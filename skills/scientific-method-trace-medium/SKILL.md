...
Scientific Method is a empirical inquiry strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to form a question, propose hypotheses, test them, and revise based on observations, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, scientific method changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Scientific Method, not like a separate response pasted after the trace.

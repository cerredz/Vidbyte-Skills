...
SWOT Reasoning is a strategic analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to separate strengths, weaknesses, opportunities, and threats before synthesizing strategy, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, swot reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of SWOT Reasoning, not like a separate response pasted after the trace.

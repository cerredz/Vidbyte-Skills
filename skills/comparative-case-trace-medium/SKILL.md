...
Comparative Case Reasoning is a case comparison strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to compare cases systematically to isolate similarities, differences, and transfer limits, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, comparative case reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Comparative Case Reasoning, not like a separate response pasted after the trace.

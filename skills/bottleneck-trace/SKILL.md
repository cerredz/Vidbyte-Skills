...
description: >
  Use this skill when the user invokes /bottleneck-trace or asks for a default public reasoning trace using Bottleneck Reasoning.
...
# Bottleneck Reasoning Reasoning Trace

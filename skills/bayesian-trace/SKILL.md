...
name: bayesian-trace
description: >
  Use this skill when the user invokes /bayesian-trace or asks for a default public reasoning trace using Bayesian Reasoning.
...
# Bayesian Reasoning Reasoning Trace

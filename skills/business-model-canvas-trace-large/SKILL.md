---
name: business-model-canvas-trace-large
description: >
  Use this skill when the user invokes /business-model-canvas-trace-large or asks for a large public reasoning trace using Business Model Canvas.
...
# Business Model Canvas Reasoning Trace Large

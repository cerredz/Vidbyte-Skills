...
description: "Use this skill when the user invokes /dialectical-trace or asks for a default public reasoning trace using Dialectical Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Dialectical Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Dialectical Reasoning strategy.
...
Apply Dialectical Reasoning by using it to develop thesis, antithesis, and synthesis while preserving the strongest opposing insight, and make each numbered line advance that method rather than adding generic filler.
...
Dialectical Reasoning is a tension synthesis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to develop thesis, antithesis, and synthesis while preserving the strongest opposing insight, which helps the model expose reasoning checkpoints that a reader can inspect.

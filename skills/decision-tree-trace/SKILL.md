---
name: decision-tree-trace
description: >
  Use this skill when the user invokes /decision-tree-trace or asks for a default public reasoning trace using Decision Tree.

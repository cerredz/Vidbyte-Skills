---
name: kolb-learning-cycle-trace-large
description: >
  Use this skill when the user invokes /kolb-learning-cycle-trace-large or asks for a large public reasoning trace using Kolb Learning Cycle.
...
# Kolb Learning Cycle Reasoning Trace Large

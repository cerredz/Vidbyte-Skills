---
name: historical-reasoning-trace
description: "Use this skill when the user invokes /historical-reasoning-trace or asks for a default public reasoning trace using Historical Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Historical Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Historical Reasoning strategy.
...
Apply Historical Reasoning by using it to interpret events through chronology, context, sources, causation, and contingency, and make each numbered line advance that method rather than adding generic filler.
...
Historical Reasoning is a contextual analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to interpret events through chronology, context, sources, causation, and contingency, which helps the model expose reasoning checkpoints that a reader can inspect.

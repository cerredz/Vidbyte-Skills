---
name: nth-order-effects-trace-large
description: >
  Use this skill when the user invokes /nth-order-effects-trace-large or asks for a large public reasoning trace using Nth Order Effects.
...
# Nth Order Effects Reasoning Trace Large

---
name: assumption-ladder-trace-large
description: >
  Use this skill when the user invokes /assumption-ladder-trace-large or asks for a large public reasoning trace using Assumption Ladder.
...
# Assumption Ladder Reasoning Trace Large

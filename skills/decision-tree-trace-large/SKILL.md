---
name: decision-tree-trace-large
description: >
  Use this skill when the user invokes /decision-tree-trace-large or asks for a large public reasoning trace using Decision Tree.
...
# Decision Tree Reasoning Trace Large

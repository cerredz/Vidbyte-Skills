---
name: base-rate-trace-large
description: >
  Use this skill when the user invokes /base-rate-trace-large or asks for a large public reasoning trace using Base Rate Reasoning.
...
# Base Rate Reasoning Reasoning Trace Large

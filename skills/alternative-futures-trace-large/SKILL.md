---
name: alternative-futures-trace-large
description: >
  Use this skill when the user invokes /alternative-futures-trace-large or asks for a large public reasoning trace using Alternative Futures.
...
# Alternative Futures Reasoning Trace Large

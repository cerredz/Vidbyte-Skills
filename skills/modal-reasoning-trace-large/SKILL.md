---
name: modal-reasoning-trace-large
description: >
  Use this skill when the user invokes /modal-reasoning-trace-large or asks for a large public reasoning trace using Modal Reasoning.
...
# Modal Reasoning Reasoning Trace Large

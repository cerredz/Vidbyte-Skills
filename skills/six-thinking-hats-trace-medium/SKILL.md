...
Six Thinking Hats is a parallel thinking strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to separate facts, feelings, risks, benefits, creativity, and process control into distinct passes, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, six thinking hats changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Six Thinking Hats, not like a separate response pasted after the trace.

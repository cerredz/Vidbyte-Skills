---
name: dependency-mapping-trace
description: >
  Use this skill when the user invokes /dependency-mapping-trace or asks for a default public reasoning trace using Dependency Mapping.
...
# Dependency Mapping Reasoning Trace

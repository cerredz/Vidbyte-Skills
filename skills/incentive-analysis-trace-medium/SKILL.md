...
Incentive Analysis is a behavioral systems analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to infer behavior from rewards, constraints, penalties, and information available to actors, which forces the model to make the important reasoning moves visible.
This strategy is strongest when the question benefits from understanding interacting parts and finding where change will matter most and when the reader needs to see why the answer follows.
Compared with a generic scratchpad, incentive analysis changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Incentive Analysis, not like a separate response pasted after the trace.

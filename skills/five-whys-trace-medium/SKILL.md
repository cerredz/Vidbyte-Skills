...
Five Whys is a root cause analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to ask why repeatedly until the trace reaches a cause that can be acted on or tested, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, five whys changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Five Whys, not like a separate response pasted after the trace.

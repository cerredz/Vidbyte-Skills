---
name: fault-tree-trace-large
description: >
  Use this skill when the user invokes /fault-tree-trace-large or asks for a large public reasoning trace using Fault Tree Analysis.
...
# Fault Tree Analysis Reasoning Trace Large

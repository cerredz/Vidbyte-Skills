...
description: "Use this skill when the user invokes /modal-reasoning-trace or asks for a default public reasoning trace using Modal Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Modal Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Modal Reasoning strategy.
...
Apply Modal Reasoning by using it to separate what is necessary, possible, impossible, and contingent, and make each numbered line advance that method rather than adding generic filler.
...
Modal Reasoning is a possibility and necessity logic strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to separate what is necessary, possible, impossible, and contingent, which helps the model expose reasoning checkpoints that a reader can inspect.

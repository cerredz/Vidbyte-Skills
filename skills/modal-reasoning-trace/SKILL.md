---
name: modal-reasoning-trace
description: >
  Use this skill when the user invokes /modal-reasoning-trace or asks for a default public reasoning trace using Modal Reasoning.
...
# Modal Reasoning Reasoning Trace

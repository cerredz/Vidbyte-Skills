---
name: empathy-mapping-trace-large
description: >
  Use this skill when the user invokes /empathy-mapping-trace-large or asks for a large public reasoning trace using Empathy Mapping.
...
# Empathy Mapping Reasoning Trace Large

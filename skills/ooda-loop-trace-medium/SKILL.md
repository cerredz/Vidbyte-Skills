...
OODA Loop is a adaptive decision cycle strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to observe, orient, decide, and act while updating the trace as the situation changes, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, ooda loop changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of OODA Loop, not like a separate response pasted after the trace.

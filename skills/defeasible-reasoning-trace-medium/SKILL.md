...
Defeasible Reasoning is a revisable logic strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to make provisional conclusions that can be withdrawn when stronger contrary evidence appears, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, defeasible reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Defeasible Reasoning, not like a separate response pasted after the trace.

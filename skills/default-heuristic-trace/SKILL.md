---
name: default-heuristic-trace
description: >
  Use this skill when the user invokes /default-heuristic-trace or asks for a default public reasoning trace using Default Heuristic.
...
# Default Heuristic Reasoning Trace

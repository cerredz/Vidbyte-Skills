---
name: ansoff-matrix-trace
description: >
  Use this skill when the user invokes /ansoff-matrix-trace or asks for a default public reasoning trace using Ansoff Matrix.

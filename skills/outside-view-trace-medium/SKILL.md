...
Outside View is a forecast calibration strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to compare the case to a reference class before trusting inside details, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, outside view changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Outside View, not like a separate response pasted after the trace.

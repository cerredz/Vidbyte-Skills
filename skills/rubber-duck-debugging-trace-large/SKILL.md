---
name: rubber-duck-debugging-trace-large
description: >
  Use this skill when the user invokes /rubber-duck-debugging-trace-large or asks for a large public reasoning trace using Rubber Duck Debugging.
...
# Rubber Duck Debugging Reasoning Trace Large

---
name: temporal-reasoning-trace
description: >
  Use this skill when the user invokes /temporal-reasoning-trace or asks for a default public reasoning trace using Temporal Reasoning.
...
# Temporal Reasoning Reasoning Trace

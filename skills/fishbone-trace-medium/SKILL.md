...
Fishbone Diagram Reasoning is a root cause analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to sort candidate causes into categories so missing families of causes become visible, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, fishbone diagram reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Fishbone Diagram Reasoning, not like a separate response pasted after the trace.

---
name: ansoff-matrix-trace-large
description: >
  Use this skill when the user invokes /ansoff-matrix-trace-large or asks for a large public reasoning trace using Ansoff Matrix.
...
# Ansoff Matrix Reasoning Trace Large

...
description: "Use this skill when the user invokes /data-quality-audit-trace or asks for a default public reasoning trace using Data Quality Audit. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Data Quality Audit Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Data Quality Audit strategy.
...
Apply Data Quality Audit by using it to inspect completeness, accuracy, freshness, lineage, and measurement bias, and make each numbered line advance that method rather than adding generic filler.
...
Data Quality Audit is a evidence reliability strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to inspect completeness, accuracy, freshness, lineage, and measurement bias, which helps the model expose reasoning checkpoints that a reader can inspect.

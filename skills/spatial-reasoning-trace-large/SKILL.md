---
name: spatial-reasoning-trace-large
description: >
  Use this skill when the user invokes /spatial-reasoning-trace-large or asks for a large public reasoning trace using Spatial Reasoning.
...
# Spatial Reasoning Reasoning Trace Large

...
Socratic Questioning is a question-driven inquiry strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to turn assertions into precise questions, probe definitions and assumptions, and answer each question in sequence, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, socratic questioning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Socratic Questioning, not like a separate response pasted after the trace.

---
name: empathy-mapping-trace
description: >
  Use this skill when the user invokes /empathy-mapping-trace or asks for a default public reasoning trace using Empathy Mapping.
...
# Empathy Mapping Reasoning Trace

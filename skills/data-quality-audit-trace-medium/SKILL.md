...
Data Quality Audit is a evidence reliability strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to inspect completeness, accuracy, freshness, lineage, and measurement bias, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, data quality audit changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Data Quality Audit, not like a separate response pasted after the trace.

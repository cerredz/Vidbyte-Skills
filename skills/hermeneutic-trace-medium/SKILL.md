...
Hermeneutic Reasoning is a interpretive analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to move between parts and whole to refine interpretation of a text, event, or artifact, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, hermeneutic reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Hermeneutic Reasoning, not like a separate response pasted after the trace.

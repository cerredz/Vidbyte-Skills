---
name: tradeoff-matrix-trace
description: >
  Use this skill when the user invokes /tradeoff-matrix-trace or asks for a default public reasoning trace using Tradeoff Matrix.
...
# Tradeoff Matrix Reasoning Trace

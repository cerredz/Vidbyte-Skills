---
name: default-heuristic-trace-large
description: >
  Use this skill when the user invokes /default-heuristic-trace-large or asks for a large public reasoning trace using Default Heuristic.
...
# Default Heuristic Reasoning Trace Large

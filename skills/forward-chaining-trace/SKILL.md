---
name: forward-chaining-trace
description: >
  Use this skill when the user invokes /forward-chaining-trace or asks for a default public reasoning trace using Forward Chaining.

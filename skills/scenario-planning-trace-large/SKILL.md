---
name: scenario-planning-trace-large
description: >
  Use this skill when the user invokes /scenario-planning-trace-large or asks for a large public reasoning trace using Scenario Planning.
...
# Scenario Planning Reasoning Trace Large

---
name: error-analysis-trace-large
description: >
  Use this skill when the user invokes /error-analysis-trace-large or asks for a large public reasoning trace using Error Analysis.
...
# Error Analysis Reasoning Trace Large

...
Ethical Matrix is a ethical analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to compare affected groups against principles such as wellbeing, autonomy, fairness, and responsibility, which forces the model to make the important reasoning moves visible.
This strategy is strongest when the question benefits from balancing duties, rules, affected parties, feasibility, and justified exceptions and when the reader needs to see why the answer follows.
Compared with a generic scratchpad, ethical matrix changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Ethical Matrix, not like a separate response pasted after the trace.

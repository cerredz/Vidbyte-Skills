---
name: inductive-trace
description: >
  Use this skill when the user invokes /inductive-trace or asks for a default public reasoning trace using Inductive Reasoning.
...
# Inductive Reasoning Reasoning Trace

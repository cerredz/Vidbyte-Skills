---
name: argument-map-trace-large
description: >
  Use this skill when the user invokes /argument-map-trace-large or asks for a large public reasoning trace using Argument Mapping.
...
# Argument Mapping Reasoning Trace Large

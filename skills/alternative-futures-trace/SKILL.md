---
name: alternative-futures-trace
description: >
  Use this skill when the user invokes /alternative-futures-trace or asks for a default public reasoning trace using Alternative Futures.
...
# Alternative Futures Reasoning Trace

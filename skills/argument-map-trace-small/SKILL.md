---
name: argument-map-trace-small
description: >
  Use this skill when the user invokes /argument-map-trace-small or asks for a small public reasoning trace using Argument Mapping.
...
# Argument Mapping Reasoning Trace Small

---
name: proof-by-cases-trace-large
description: >
  Use this skill when the user invokes /proof-by-cases-trace-large or asks for a large public reasoning trace using Proof By Cases.
...
# Proof By Cases Reasoning Trace Large

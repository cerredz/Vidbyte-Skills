---
name: value-chain-analysis-trace-small
description: >
  Use this skill when the user invokes /value-chain-analysis-trace-small or asks for a small public reasoning trace using Value Chain Analysis.
...
# Value Chain Analysis Reasoning Trace Small

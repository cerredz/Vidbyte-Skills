...
Quasi Experimental Reasoning is a causal inference strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to use imperfect natural comparisons while naming threats to validity, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, quasi experimental reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Quasi Experimental Reasoning, not like a separate response pasted after the trace.

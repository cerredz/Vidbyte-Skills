---
name: inversion-trace
description: >
  Use this skill when the user invokes /inversion-trace or asks for a default public reasoning trace using Inversion.

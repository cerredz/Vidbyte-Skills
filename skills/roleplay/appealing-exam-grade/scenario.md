# Scenario: Appealing an Exam Grade
...
**Age:** 24
**Current Role:** Graduate Teaching Assistant (TA)
**Background:** Arthur is a busy graduate student who graded 150 exams in a single weekend. He wants to maintain grading consistency across the class and is defensive about his grading accuracy. He hates being told he made a mistake.

---

## Character Personality

**Core Traits:** Busy, slightly defensive, academic-minded, detailed, stressed

**Communication Style:**
Arthur speaks in a slightly defensive, informal academic tone. He defends the grading rubric and asks the student to explain the proof step-by-step to show where the rubric was met.

**Decision-Making Pattern:**
Prioritizes class rubric consistency and avoiding grade inflation.

**Relationship to Authority:**
Reports to the course professor; manages student grading disputes.

**Pet Peeves:**
- Students demanding points back without technical logic
- claiming they 'need an A,' questioning his intelligence.

**What Earns Respect:**
- Walking through the proof steps calmly
- referencing the textbook or lecture notes
- showing exactly where the logic was correct but misread
- staying polite.
...
**Deep Expertise:**
Course material, grading rubrics, academic policy.

**Awareness (Not Expert):**
HR policy, corporate structure

**What Arthur Has Seen Too Much Of:**
- Students who come to office hours to beg for partial credit on answers that were fundamentally wrong.

**Blind Spots:**
Arthur can focus so much on rules and metrics that they ignore individual developer constraints or team morale issues.
...
Tired, defensive. He expects the student to complain about the grading severity.
...
Once trust is established, Arthur will shift from a defensive stance to a collaborative partner, willing to support the proposed solution.

---

## The Situation (From Arthur's POV)
...
You are the primary person responsible for this issue. You need to drive the conversation, present your case, address Arthur's concerns, and secure agreement on next steps.
...
> "I graded everyone strictly according to the professor's rubric. Which question are you disputing, and why?"
...
1. **What course is this exam for**: What course is this exam for?
2. **What is the question number you are appealing**: What is the question number you are appealing?
3. **How many points were deducted**: How many points were deducted?

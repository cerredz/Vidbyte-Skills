---
name: leverage-points-trace
description: >
  Use this skill when the user invokes /leverage-points-trace or asks for a default public reasoning trace using Leverage Points.
...
# Leverage Points Reasoning Trace

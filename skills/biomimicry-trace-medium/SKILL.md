...
Biomimicry Reasoning is a analogical design strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to look to biological systems for patterns that can be adapted to the current challenge, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, biomimicry reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Biomimicry Reasoning, not like a separate response pasted after the trace.

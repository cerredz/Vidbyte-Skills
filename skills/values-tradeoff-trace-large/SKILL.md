---
name: values-tradeoff-trace-large
description: >
  Use this skill when the user invokes /values-tradeoff-trace-large or asks for a large public reasoning trace using Values Tradeoff Reasoning.
...
# Values Tradeoff Reasoning Reasoning Trace Large

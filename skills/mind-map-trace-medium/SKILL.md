...
Mind Mapping is a associative exploration strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to radiate related concepts from a central question and cluster them into patterns, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, mind mapping changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Mind Mapping, not like a separate response pasted after the trace.

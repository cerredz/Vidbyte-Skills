---
name: issue-tree-trace
description: >
  Use this skill when the user invokes /issue-tree-trace or asks for a default public reasoning trace using Issue Tree.

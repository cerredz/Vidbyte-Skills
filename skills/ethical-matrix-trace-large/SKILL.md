---
name: ethical-matrix-trace-large
description: >
  Use this skill when the user invokes /ethical-matrix-trace-large or asks for a large public reasoning trace using Ethical Matrix.
...
# Ethical Matrix Reasoning Trace Large

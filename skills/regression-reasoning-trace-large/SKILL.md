---
name: regression-reasoning-trace-large
description: >
  Use this skill when the user invokes /regression-reasoning-trace-large or asks for a large public reasoning trace using Regression Reasoning.
...
# Regression Reasoning Reasoning Trace Large

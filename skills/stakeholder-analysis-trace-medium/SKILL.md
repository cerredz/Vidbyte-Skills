...
Stakeholder Analysis is a social systems analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to map affected parties, incentives, power, needs, and likely reactions, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, stakeholder analysis changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Stakeholder Analysis, not like a separate response pasted after the trace.

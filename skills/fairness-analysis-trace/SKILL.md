---
name: fairness-analysis-trace
description: >
  Use this skill when the user invokes /fairness-analysis-trace or asks for a default public reasoning trace using Fairness Analysis.
...
# Fairness Analysis Reasoning Trace

---
name: after-action-review-trace-large
description: >
  Use this skill when the user invokes /after-action-review-trace-large or asks for a large public reasoning trace using After Action Review.
...
# After Action Review Reasoning Trace Large

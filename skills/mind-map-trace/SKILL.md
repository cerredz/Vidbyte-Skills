---
name: mind-map-trace
description: "Use this skill when the user invokes /mind-map-trace or asks for a default public reasoning trace using Mind Mapping. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Mind Mapping Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Mind Mapping strategy.
...
Apply Mind Mapping by using it to radiate related concepts from a central question and cluster them into patterns, and make each numbered line advance that method rather than adding generic filler.
...
Mind Mapping is a associative exploration strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to radiate related concepts from a central question and cluster them into patterns, which helps the model expose reasoning checkpoints that a reader can inspect.

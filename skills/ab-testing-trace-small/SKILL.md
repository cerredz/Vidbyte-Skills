...
description: "Use this skill when the user invokes /ab-testing-trace-small or asks for a small public reasoning trace using A B Testing. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

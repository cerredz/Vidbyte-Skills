---
name: ab-testing-trace-small
description: >
  Use this skill when the user invokes /ab-testing-trace-small or asks for a small public reasoning trace using A B Testing.
...
# A B Testing Reasoning Trace Small

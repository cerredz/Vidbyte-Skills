...
Legal Reasoning is a rule and precedent analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to identify governing rules, apply them to facts, and distinguish contrary authorities, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, legal reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Legal Reasoning, not like a separate response pasted after the trace.

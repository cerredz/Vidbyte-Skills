---
name: second-order-effects-trace
description: >
  Use this skill when the user invokes /second-order-effects-trace or asks for a default public reasoning trace using Second Order Effects.
...
# Second Order Effects Reasoning Trace

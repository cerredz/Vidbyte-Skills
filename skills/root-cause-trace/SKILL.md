...
description: >
  Use this skill when the user invokes /root-cause-trace or asks for a default public reasoning trace using Root Cause Reasoning.
...
# Root Cause Reasoning Reasoning Trace

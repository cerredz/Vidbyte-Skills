...
Devils Advocacy is a adversarial critique strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to argue against the favored answer to expose unsupported claims and hidden vulnerabilities, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, devils advocacy changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Devils Advocacy, not like a separate response pasted after the trace.

...
description: "Use this skill when the user invokes /cost-benefit-trace or asks for a default public reasoning trace using Cost Benefit Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Cost Benefit Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Cost Benefit Reasoning strategy.
...
Apply Cost Benefit Reasoning by using it to identify costs, benefits, timing, risk, and distribution before recommending action, and make each numbered line advance that method rather than adding generic filler.
...
Cost Benefit Reasoning is a decision analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to identify costs, benefits, timing, risk, and distribution before recommending action, which helps the model expose reasoning checkpoints that a reader can inspect.

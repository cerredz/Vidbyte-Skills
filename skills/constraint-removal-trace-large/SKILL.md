---
name: constraint-removal-trace-large
description: >
  Use this skill when the user invokes /constraint-removal-trace-large or asks for a large public reasoning trace using Constraint Removal.
...
# Constraint Removal Reasoning Trace Large

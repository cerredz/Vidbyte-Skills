---
name: key-assumptions-check-trace-large
description: >
  Use this skill when the user invokes /key-assumptions-check-trace-large or asks for a large public reasoning trace using Key Assumptions Check.
...
# Key Assumptions Check Reasoning Trace Large

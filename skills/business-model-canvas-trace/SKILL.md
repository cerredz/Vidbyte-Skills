---
name: business-model-canvas-trace
description: >
  Use this skill when the user invokes /business-model-canvas-trace or asks for a default public reasoning trace using Business Model Canvas.
...
# Business Model Canvas Reasoning Trace

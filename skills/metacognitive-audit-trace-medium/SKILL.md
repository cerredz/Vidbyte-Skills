...
Metacognitive Audit is a thinking quality review strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to inspect the reasoning process itself for bias, gaps, overconfidence, and poor framing, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, metacognitive audit changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Metacognitive Audit, not like a separate response pasted after the trace.

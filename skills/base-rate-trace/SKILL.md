---
name: base-rate-trace
description: >
  Use this skill when the user invokes /base-rate-trace or asks for a default public reasoning trace using Base Rate Reasoning.
...
# Base Rate Reasoning Reasoning Trace

---
name: predicate-logic-trace-large
description: >
  Use this skill when the user invokes /predicate-logic-trace-large or asks for a large public reasoning trace using Predicate Logic Reasoning.
...
# Predicate Logic Reasoning Reasoning Trace Large

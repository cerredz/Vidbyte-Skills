...
Backward Chaining is a goal-driven inference strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to start from the desired conclusion and work backward to required premises or actions, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, backward chaining changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Backward Chaining, not like a separate response pasted after the trace.

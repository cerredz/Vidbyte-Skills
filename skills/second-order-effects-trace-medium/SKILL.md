...
Second Order Effects is a consequence analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to reason beyond immediate outcomes into follow-on effects and feedback, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, second order effects changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Second Order Effects, not like a separate response pasted after the trace.

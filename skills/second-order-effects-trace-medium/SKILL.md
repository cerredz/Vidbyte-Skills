...
description: "Use this skill when the user invokes /second-order-effects-trace-medium or asks for a medium public reasoning trace using Second Order Effects. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 100 numbered scratchpad lines."
---

---
name: metacognitive-audit-trace-large
description: >
  Use this skill when the user invokes /metacognitive-audit-trace-large or asks for a large public reasoning trace using Metacognitive Audit.
...
# Metacognitive Audit Reasoning Trace Large

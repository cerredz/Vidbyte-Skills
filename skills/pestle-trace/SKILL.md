---
name: pestle-trace
description: "Use this skill when the user invokes /pestle-trace or asks for a default public reasoning trace using PESTLE Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# PESTLE Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the PESTLE Reasoning strategy.
...
Apply PESTLE Reasoning by using it to scan political, economic, social, technological, legal, and environmental forces, and make each numbered line advance that method rather than adding generic filler.
...
PESTLE Reasoning is a macro-environment analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to scan political, economic, social, technological, legal, and environmental forces, which helps the model expose reasoning checkpoints that a reader can inspect.

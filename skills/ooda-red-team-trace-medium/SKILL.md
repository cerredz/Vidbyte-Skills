...
OODA Red Team is a adversarial adaptation strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to run the OODA cycle from an opposing actor's perspective and compare likely moves, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, ooda red team changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of OODA Red Team, not like a separate response pasted after the trace.

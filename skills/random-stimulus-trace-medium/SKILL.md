...
Random Stimulus is a creative provocation strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to introduce an unrelated cue and force useful connections to the target problem, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, random stimulus changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Random Stimulus, not like a separate response pasted after the trace.

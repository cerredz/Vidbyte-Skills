---
name: bcg-matrix-trace
description: >
  Use this skill when the user invokes /bcg-matrix-trace or asks for a default public reasoning trace using BCG Growth-Share Matrix.
...
# BCG Growth-Share Matrix Reasoning Trace

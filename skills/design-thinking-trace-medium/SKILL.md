...
Design Thinking is a human-centered design strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to empathize, define, ideate, prototype, and test around user needs, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, design thinking changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Design Thinking, not like a separate response pasted after the trace.

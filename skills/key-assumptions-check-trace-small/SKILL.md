---
name: key-assumptions-check-trace-small
description: >
  Use this skill when the user invokes /key-assumptions-check-trace-small or asks for a small public reasoning trace using Key Assumptions Check.
...
# Key Assumptions Check Reasoning Trace Small

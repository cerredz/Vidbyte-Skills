---
name: blue-ocean-strategy-trace
description: >
  Use this skill when the user invokes /blue-ocean-strategy-trace or asks for a default public reasoning trace using Blue Ocean Strategy.
...
# Blue Ocean Strategy Reasoning Trace

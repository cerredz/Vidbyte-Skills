---
name: bowtie-risk-trace
description: >
  Use this skill when the user invokes /bowtie-risk-trace or asks for a default public reasoning trace using Bowtie Risk Reasoning.
...
# Bowtie Risk Reasoning Reasoning Trace

...
Feedback Loop Reasoning is a systems analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to identify reinforcing and balancing loops, then trace their effects over time, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, feedback loop reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Feedback Loop Reasoning, not like a separate response pasted after the trace.

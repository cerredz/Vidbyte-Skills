---
name: value-stream-mapping-trace
description: >
  Use this skill when the user invokes /value-stream-mapping-trace or asks for a default public reasoning trace using Value Stream Mapping.
...
# Value Stream Mapping Reasoning Trace

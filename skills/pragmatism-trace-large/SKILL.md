---
name: pragmatism-trace-large
description: >
  Use this skill when the user invokes /pragmatism-trace-large or asks for a large public reasoning trace using Pragmatism.
...
# Pragmatism Reasoning Trace Large

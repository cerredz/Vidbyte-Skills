...
description: "Use this skill when the user invokes /systems-thinking-trace or asks for a default public reasoning trace using Systems Thinking. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Systems Thinking Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Systems Thinking strategy.
...
Apply Systems Thinking by using it to map components, relationships, boundaries, feedback, delays, and emergent behavior, and make each numbered line advance that method rather than adding generic filler.
...
Systems Thinking is a systems analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to map components, relationships, boundaries, feedback, delays, and emergent behavior, which helps the model expose reasoning checkpoints that a reader can inspect.

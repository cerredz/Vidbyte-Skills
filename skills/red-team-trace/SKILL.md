---
name: red-team-trace
description: "Use this skill when the user invokes /red-team-trace or asks for a default public reasoning trace using Red Team Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Red Team Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Red Team Reasoning strategy.
...
Apply Red Team Reasoning by using it to simulate a capable opponent or critic to stress-test plans, claims, and defenses, and make each numbered line advance that method rather than adding generic filler.
...
Red Team Reasoning is a adversarial critique strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to simulate a capable opponent or critic to stress-test plans, claims, and defenses, which helps the model expose reasoning checkpoints that a reader can inspect.

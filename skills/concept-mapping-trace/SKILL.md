---
name: concept-mapping-trace
description: >
  Use this skill when the user invokes /concept-mapping-trace or asks for a default public reasoning trace using Concept Mapping.
...
# Concept Mapping Reasoning Trace

---
name: simulation-heuristic-trace-large
description: >
  Use this skill when the user invokes /simulation-heuristic-trace-large or asks for a large public reasoning trace using Simulation Heuristic.
...
# Simulation Heuristic Reasoning Trace Large

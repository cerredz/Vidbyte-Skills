---
name: tradeoff-matrix-trace-small
description: >
  Use this skill when the user invokes /tradeoff-matrix-trace-small or asks for a small public reasoning trace using Tradeoff Matrix.
...
# Tradeoff Matrix Reasoning Trace Small

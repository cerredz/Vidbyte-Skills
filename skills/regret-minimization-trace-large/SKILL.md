---
name: regret-minimization-trace-large
description: >
  Use this skill when the user invokes /regret-minimization-trace-large or asks for a large public reasoning trace using Regret Minimization.
...
# Regret Minimization Reasoning Trace Large

...
description: "Use this skill when the user invokes /six-thinking-hats-trace or asks for a default public reasoning trace using Six Thinking Hats. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Six Thinking Hats Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Six Thinking Hats strategy.
...
Apply Six Thinking Hats by using it to separate facts, feelings, risks, benefits, creativity, and process control into distinct passes, and make each numbered line advance that method rather than adding generic filler.
...
Six Thinking Hats is a parallel thinking strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to separate facts, feelings, risks, benefits, creativity, and process control into distinct passes, which helps the model expose reasoning checkpoints that a reader can inspect.

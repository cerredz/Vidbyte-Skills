---
name: customer-journey-mapping-trace
description: >
  Use this skill when the user invokes /customer-journey-mapping-trace or asks for a default public reasoning trace using Customer Journey Mapping.
...
# Customer Journey Mapping Reasoning Trace

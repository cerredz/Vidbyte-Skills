...
What If Analysis is a scenario stress testing strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to alter one important condition at a time and track how the answer changes, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, what if analysis changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of What If Analysis, not like a separate response pasted after the trace.

---
name: phenomenology-trace-medium
description: >
  Use this skill when the user invokes /phenomenology-trace-medium or asks for a medium public reasoning trace using Phenomenological Method.
  The skill writes a durable scratchpad to root memory/{question_name}.md and uses Phenomenological Method as the actual structure of the analysis.
  ...
  Use this skill when the user wants the answer shaped by bracketing assumptions to examine lived experience as it is directly given instead of a generic response.
---

# Phenomenological Method Reasoning Trace Medium

## Goal
Use Phenomenological Method to answer the user's question through bracketing assumptions to examine lived experience as it is directly given, not through a generic checklist or interchangeable trace.
The trace should bracket prior assumptions and examine the structure of lived experience as it is directly given to consciousness, so the visible reasoning follows the same path the strategy is known for.
The goal is to create a public scratchpad that a reviewer can audit without exposing hidden private chain-of-thought.
Center the scratchpad on subquestions, assumptions, evidence, contrasts, tests, intermediate conclusions, and implications, because those artifacts make phenomenological method useful rather than decorative.
...
Build the scratchpad by repeatedly applying the Phenomenological Method move: bracket prior assumptions and examine the structure of lived experience as it is directly given to consciousness.
...
Phenomenological Method is a reasoning strategy for turning a question into an auditable public trace instead of an unstructured opinion.
...
Use it when the problem benefits from the core move "bracket prior assumptions and examine the structure of lived experience as it is directly given to consciousness" and when the final answer needs evidence, assumptions, and uncertainty kept in view.
A strong Phenomenological Method trace lets that move determine the order and granularity of the scratchpad, then compresses the result into a concise final answer.

Algorithm for the output document:
1. Restate the user's question, constraints, and evidence standard, then derive the subquestions or working items that Phenomenological Method needs to inspect.
2. Apply the core move explicitly: bracket prior assumptions and examine the structure of lived experience as it is directly given to consciousness.
...
5. Synthesize the completed trace into the final answer, showing how the conclusion follows from Phenomenological Method rather than from a generic summary.

---
name: randomized-control-trial-trace
description: >
  Use this skill when the user invokes /randomized-control-trial-trace or asks for a default public reasoning trace using Randomized Control Trial.
...
# Randomized Control Trial Reasoning Trace

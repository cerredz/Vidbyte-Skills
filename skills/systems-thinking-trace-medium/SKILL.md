...
Systems Thinking is a systems analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to map components, relationships, boundaries, feedback, delays, and emergent behavior, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, systems thinking changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Systems Thinking, not like a separate response pasted after the trace.

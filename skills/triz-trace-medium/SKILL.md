...
TRIZ Reasoning is a inventive problem solving strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to name contradictions, search invention patterns, and resolve constraints without simple compromise, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, triz reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of TRIZ Reasoning, not like a separate response pasted after the trace.

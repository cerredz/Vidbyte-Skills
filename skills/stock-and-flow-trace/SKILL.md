---
name: stock-and-flow-trace
description: >
  Use this skill when the user invokes /stock-and-flow-trace or asks for a default public reasoning trace using Stock And Flow Reasoning.
...
# Stock And Flow Reasoning Reasoning Trace

---
name: decision-matrix-trace-large
description: >
  Use this skill when the user invokes /decision-matrix-trace-large or asks for a large public reasoning trace using Decision Matrix.
...
# Decision Matrix Reasoning Trace Large

...
description: "Use this skill when the user invokes /synectics-trace or asks for a default public reasoning trace using Synectics Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# Synectics Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the Synectics Reasoning strategy.
...
Apply Synectics Reasoning by using it to use direct, personal, symbolic, and fantasy analogies to reframe the problem, and make each numbered line advance that method rather than adding generic filler.
...
Synectics Reasoning is a creative analogy strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to use direct, personal, symbolic, and fantasy analogies to reframe the problem, which helps the model expose reasoning checkpoints that a reader can inspect.

---
name: ooda-loop-trace
description: >
  Use this skill when the user invokes /ooda-loop-trace or asks for a default public reasoning trace using OODA Loop.

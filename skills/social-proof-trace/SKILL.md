---
name: social-proof-trace
description: >
  Use this skill when the user invokes /social-proof-trace or asks for a default public reasoning trace using Social Proof.

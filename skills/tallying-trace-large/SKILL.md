---
name: tallying-trace-large
description: >
  Use this skill when the user invokes /tallying-trace-large or asks for a large public reasoning trace using Tallying.
...
# Tallying Reasoning Trace Large

---
name: indicators-signposts-trace
description: >
  Use this skill when the user invokes /indicators-signposts-trace or asks for a default public reasoning trace using Indicators And Signposts.
...
# Indicators And Signposts Reasoning Trace

...
description: Use this skill when the user wants guided Gibbs' Reflective Cycle applied to real work. It teaches the source-grounded method, halts for observable user work, evaluates each gate, and produces a structured handoff.
---
...
Ask the user to perform this move on the actual subject. Require a bounded factual account.

End the response immediately after the gate. Do not preview later phases.

### Evaluation

Pass only when the response contains a bounded factual account. On first failure, identify the missing criterion and request a full retry. On second and later failure, add one targeted cue without supplying the missing content. Preserve accepted user wording separately from agent evaluation.

## Phase 2 of 6 — Feelings
...
Ask the user to perform this move on the actual subject. Require user-owned affect and cognition.

End the response immediately after the gate. Do not preview later phases.

### Evaluation

Pass only when the response contains user-owned affect and cognition. On first failure, identify the missing criterion and request a full retry. On second and later failure, add one targeted cue without supplying the missing content. Preserve accepted user wording separately from agent evaluation.

## Phase 3 of 6 — Evaluation
...
Ask the user to perform this move on the actual subject. Require specific positives and negatives.

End the response immediately after the gate. Do not preview later phases.

### Evaluation

Pass only when the response contains specific positives and negatives. On first failure, identify the missing criterion and request a full retry. On second and later failure, add one targeted cue without supplying the missing content. Preserve accepted user wording separately from agent evaluation.

## Phase 4 of 6 — Analysis

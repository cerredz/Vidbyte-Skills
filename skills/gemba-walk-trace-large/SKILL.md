---
name: gemba-walk-trace-large
description: >
  Use this skill when the user invokes /gemba-walk-trace-large or asks for a large public reasoning trace using Gemba Walk.
...
# Gemba Walk Reasoning Trace Large

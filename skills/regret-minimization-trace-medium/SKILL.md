...
Regret Minimization is a decision analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to compare future remorse across choices and reduce the cost of being wrong, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, regret minimization changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Regret Minimization, not like a separate response pasted after the trace.

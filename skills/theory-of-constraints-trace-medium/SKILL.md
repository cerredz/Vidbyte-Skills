...
Theory Of Constraints is a constraint analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to identify the system constraint, exploit it, subordinate other work, and reassess, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, theory of constraints changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Theory Of Constraints, not like a separate response pasted after the trace.

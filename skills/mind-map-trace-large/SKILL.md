---
name: mind-map-trace-large
description: >
  Use this skill when the user invokes /mind-map-trace-large or asks for a large public reasoning trace using Mind Mapping.
...
# Mind Mapping Reasoning Trace Large

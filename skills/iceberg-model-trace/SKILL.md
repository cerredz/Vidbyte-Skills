---
name: iceberg-model-trace
description: >
  Use this skill when the user invokes /iceberg-model-trace or asks for a default public reasoning trace using Iceberg Model.

...
Reverse Brainstorming is a creative inversion strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to ask how to worsen the outcome, then reverse those causes into improvements, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, reverse brainstorming changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Reverse Brainstorming, not like a separate response pasted after the trace.

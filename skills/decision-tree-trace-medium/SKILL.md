...
Decision Tree is a branching decision analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to represent choices, uncertain events, and outcomes as branches that can be compared, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, decision tree changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Decision Tree, not like a separate response pasted after the trace.

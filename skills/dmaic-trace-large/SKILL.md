---
name: dmaic-trace-large
description: >
  Use this skill when the user invokes /dmaic-trace-large or asks for a large public reasoning trace using DMAIC Methodology.
...
# DMAIC Methodology Reasoning Trace Large

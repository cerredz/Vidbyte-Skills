...
Dependency Mapping is a systems decomposition strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to map prerequisites, blockers, interfaces, and sequencing before recommending work, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, dependency mapping changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Dependency Mapping, not like a separate response pasted after the trace.

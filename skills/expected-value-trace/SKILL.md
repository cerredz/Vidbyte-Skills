---
name: expected-value-trace
description: >
  Use this skill when the user invokes /expected-value-trace or asks for a default public reasoning trace using Expected Value Reasoning.
...
# Expected Value Reasoning Reasoning Trace

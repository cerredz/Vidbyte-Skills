---
name: kolb-learning-cycle-trace-medium
description: >
  Use this skill when the user invokes /kolb-learning-cycle-trace-medium or asks for a medium public reasoning trace using Kolb Learning Cycle.
  The skill writes a durable scratchpad to root memory/{question_name}.md and uses Kolb Learning Cycle as the actual structure of the analysis.
  ...
  Use this skill when the user wants the answer shaped by learning through concrete experience, reflective observation, abstract conceptualization, and active experimentation instead of a generic response.
---

# Kolb Learning Cycle Reasoning Trace Medium

## Goal
Use Kolb Learning Cycle to answer the user's question through learning through concrete experience, reflective observation, abstract conceptualization, and active experimentation, not through a generic checklist or interchangeable trace.
The trace should cycle through four stages: concrete experience, reflective observation, abstract conceptualization, and active experimentation, to transform experience into knowledge, so the visible reasoning follows the same path the strategy is known for.
The goal is to create a public scratchpad that a reviewer can audit without exposing hidden private chain-of-thought.
Center the scratchpad on subquestions, assumptions, evidence, contrasts, tests, intermediate conclusions, and implications, because those artifacts make kolb learning cycle useful rather than decorative.
...
Build the scratchpad by repeatedly applying the Kolb Learning Cycle move: cycle through four stages: concrete experience, reflective observation, abstract conceptualization, and active experimentation, to transform experience into knowledge.
...
Kolb Learning Cycle is a reasoning strategy for turning a question into an auditable public trace instead of an unstructured opinion.
...
Use it when the problem benefits from the core move "cycle through four stages: concrete experience, reflective observation, abstract conceptualization, and active experimentation, to transform experience into knowledge" and when the final answer needs evidence, assumptions, and uncertainty kept in view.
A strong Kolb Learning Cycle trace lets that move determine the order and granularity of the scratchpad, then compresses the result into a concise final answer.

Algorithm for the output document:
1. Restate the user's question, constraints, and evidence standard, then derive the subquestions or working items that Kolb Learning Cycle needs to inspect.
2. Apply the core move explicitly: cycle through four stages: concrete experience, reflective observation, abstract conceptualization, and active experimentation, to transform experience into knowledge.
...
5. Synthesize the completed trace into the final answer, showing how the conclusion follows from Kolb Learning Cycle rather than from a generic summary.

...
Proof By Cases is a formal logic strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to split the problem into exhaustive cases and prove the conclusion within each case, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, proof by cases changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Proof By Cases, not like a separate response pasted after the trace.

---
name: fluency-heuristic-trace
description: >
  Use this skill when the user invokes /fluency-heuristic-trace or asks for a default public reasoning trace using Fluency Heuristic.
...
# Fluency Heuristic Reasoning Trace

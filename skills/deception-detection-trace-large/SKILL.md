---
name: deception-detection-trace-large
description: >
  Use this skill when the user invokes /deception-detection-trace-large or asks for a large public reasoning trace using Deception Detection.
...
# Deception Detection Reasoning Trace Large

...
MECE Decomposition is a structured decomposition strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to split the problem into mutually exclusive and collectively exhaustive parts before solving each part, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, mece decomposition changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of MECE Decomposition, not like a separate response pasted after the trace.

---
name: triz-trace-large
description: >
  Use this skill when the user invokes /triz-trace-large or asks for a large public reasoning trace using TRIZ Reasoning.
...
# TRIZ Reasoning Reasoning Trace Large

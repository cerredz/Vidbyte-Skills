---
name: backward-chaining-trace
description: >
  Use this skill when the user invokes /backward-chaining-trace or asks for a default public reasoning trace using Backward Chaining.
...
# Backward Chaining Reasoning Trace

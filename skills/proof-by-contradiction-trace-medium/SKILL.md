...
Proof By Contradiction is a formal logic strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to assume the opposite of the target claim and show that it creates an inconsistency, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, proof by contradiction changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Proof By Contradiction, not like a separate response pasted after the trace.

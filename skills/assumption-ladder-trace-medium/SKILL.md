...
Assumption Ladder is a metacognitive analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to climb from observations to interpretations, beliefs, and actions while checking each rung, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, assumption ladder changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Assumption Ladder, not like a separate response pasted after the trace.

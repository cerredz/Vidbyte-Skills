...
Argument Mapping is a argument analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to turn claims, supports, objections, and rebuttals into a visible logical structure, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, argument mapping changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Argument Mapping, not like a separate response pasted after the trace.

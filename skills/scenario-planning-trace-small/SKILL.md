...
description: "Use this skill when the user invokes /scenario-planning-trace-small or asks for a small public reasoning trace using Scenario Planning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to exactly 25 numbered scratchpad lines."
---

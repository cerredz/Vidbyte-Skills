---
name: what-if-analysis-trace-small
description: >
  Use this skill when the user invokes /what-if-analysis-trace-small or asks for a small public reasoning trace using What If Analysis.
...
# What If Analysis Reasoning Trace Small

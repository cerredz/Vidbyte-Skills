---
name: bottleneck-trace-large
description: >
  Use this skill when the user invokes /bottleneck-trace-large or asks for a large public reasoning trace using Bottleneck Reasoning.
...
# Bottleneck Reasoning Reasoning Trace Large

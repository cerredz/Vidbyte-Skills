---
name: proof-by-cases-trace
description: >
  Use this skill when the user invokes /proof-by-cases-trace or asks for a default public reasoning trace using Proof By Cases.
...
# Proof By Cases Reasoning Trace

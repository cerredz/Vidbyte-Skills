---
name: assumption-ladder-trace
description: >
  Use this skill when the user invokes /assumption-ladder-trace or asks for a default public reasoning trace using Assumption Ladder.
...
# Assumption Ladder Reasoning Trace

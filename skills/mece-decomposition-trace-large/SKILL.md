---
name: mece-decomposition-trace-large
description: >
  Use this skill when the user invokes /mece-decomposition-trace-large or asks for a large public reasoning trace using MECE Decomposition.
...
# MECE Decomposition Reasoning Trace Large

...
Stock And Flow Reasoning is a systems dynamics strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to distinguish accumulations from rates of change and explain delays, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, stock and flow reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Stock And Flow Reasoning, not like a separate response pasted after the trace.

---
name: influence-diagram-trace-large
description: >
  Use this skill when the user invokes /influence-diagram-trace-large or asks for a large public reasoning trace using Influence Diagram.
...
# Influence Diagram Reasoning Trace Large

---
name: fuzzy-logic-trace
description: >
  Use this skill when the user invokes /fuzzy-logic-trace or asks for a default public reasoning trace using Fuzzy Logic Reasoning.
...
# Fuzzy Logic Reasoning Reasoning Trace

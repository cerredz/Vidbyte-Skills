---
name: swot-trace
description: "Use this skill when the user invokes /swot-trace or asks for a default public reasoning trace using SWOT Reasoning. It writes a structured scratchpad to root memory/{question_name}.md and scales the trace to 100 numbered scratchpad lines unless the user explicitly requests a different scale."
---

# SWOT Reasoning Reasoning Trace

## Goal
Use this skill to produce a public, audit-friendly reasoning trace for the user's question using the SWOT Reasoning strategy.
...
Apply SWOT Reasoning by using it to separate strengths, weaknesses, opportunities, and threats before synthesizing strategy, and make each numbered line advance that method rather than adding generic filler.
...
SWOT Reasoning is a strategic analysis strategy that gives the trace a specific shape instead of a loose stream of thoughts.
Its core move is to separate strengths, weaknesses, opportunities, and threats before synthesizing strategy, which helps the model expose reasoning checkpoints that a reader can inspect.

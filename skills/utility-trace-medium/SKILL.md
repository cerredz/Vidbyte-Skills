...
Utility Reasoning is a preference analysis strategy that gives analysis a recognizable pattern and prevents the answer from becoming an unstructured opinion.
Its central discipline is to clarify objectives, weight preferences, and compare options by expected usefulness, which forces the model to make the important reasoning moves visible.
...
Compared with a generic scratchpad, utility reasoning changes what gets noticed, which alternatives get compared, and which assumptions receive pressure.
...
The final answer should feel like the compressed result of Utility Reasoning, not like a separate response pasted after the trace.
